...
namespace Octopus.Layers.DAL.APIClients
{
    internal class ServiceBCCR
    {
        private readonly string TOKEN = "EPOPL4MEUU";
        private readonly string NOMBRE = "Luis";
        private readonly string CORREO = "lviquez164@gmail.com";
